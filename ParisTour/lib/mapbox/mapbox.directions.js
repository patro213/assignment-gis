    ...
    query: function (opts) {
        ...
        q.await(L.bind(function(err) {
            ...
            this._query = request(this.queryURL(), L.bind(function (err, resp) {
                ...
                //opts.callback(this.directions.routes[0]);
...
var Layer = L.LayerGroup.extend({
    ...
    onAdd: function() {
        ...
        //this.routeLayer.bindPopup('novy').openPopup();
    ...
    // bindPopup return this.routeLayer.getLayers()[0].bindPopup('asd').openPopup();
...
module.exports = function (container, directions) {
    ...
    directions.on('load', function (e) {
        ...
        routes.append('div')
            ...
            .text(function (route) {
                return format['metric'](route.distance) + ', ' + format.duration(route.duration);
            });
